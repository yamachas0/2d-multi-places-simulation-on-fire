...
火災発生 (step40, 中央公園, intensity 0.8, radius 25) と同時に会話数が約2倍に跳ね上がった。`emergency_boost` (火災近傍で最大2.0) が `p_speak` を押し上げ、普段無言の弱い関係 (山田太郎→石川裕子 rel=0.07 など) も発話したことが messages.jsonl から確認できる。
